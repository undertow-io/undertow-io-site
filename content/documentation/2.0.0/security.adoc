...
security API. For details on how these are used in servlet deployments see link:../servlet-security/[Servlet Security].
...
required for the current request. This handler can take a link:../predicates-attributes-handlers/[Predicate]
...
image::/images/documentation/2.0.0/security_handlers.png["An Example Security Chain",title="An Example Security Chain"]
