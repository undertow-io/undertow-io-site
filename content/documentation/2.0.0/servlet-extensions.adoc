...
link:../servlet-deployment/[The deployment guide] contains examples of how to use the `DeploymentInfo` API.

link:../servlet-using-non-blocking-handlers/[Using non-blocking handlers with Servlet deployments]
