...
link:../deployment/[The deployment guide] contains examples of how to use the `DeploymentInfo` API.

link:../using-non-blocking-handlers-with-servlet/[Using non-blocking handlers with Servlet deployments]
