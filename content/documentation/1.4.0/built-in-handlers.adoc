...
exchange. For more information see the link:../predicates-attributes-handlers/[predicates guide].
...
Handler that handles incoming web socket connections. See the link:../websockets/[websockets guide] for details.
...
link:../predicates-attributes-handlers/[exchange attributes].
