---
layout: project-blog
title: Undertow 3.0 Announcement
author: Stuart Douglas
email: <sdouglas@redhat.com>
date: 2019-04-15
revision: 1.0
aliases: [/blog/2019/04/15/Undertow-3.html]
---
...
It allows sharing of threads between Undertow and other Netty-based services, resulting in services using fewer resources
The underlying transport implementations are the most complex part of Undertow, delegating this to Netty will significantly reduce the work needed to maintain Undertow
...
And the source code for 3.x is here: https://github.com/undertow-io/undertow/tree/3.x
