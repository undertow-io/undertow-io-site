---
layout: project-blog
title: Using HTTP2 With WildFly 9.0.0.Beta1
author: Stuart Douglas
email: <sdouglas@redhat.com>
date: 2015-03-26
revision: 1.0
aliases: [/blog/2015/03/26/HTTP2-In-Wildfly.html]
---
...
Have a look at https://eclipse.org/jetty/documentation/current/alpn-chapter.html to figure out which version of Jetty
ALPN is required for your JVM version. Download the correct jar version from
https://central.maven.org/maven2/org/mortbay/jetty/alpn/alpn-boot/[maven central] and place it in the WildFly bin
directory.
...
Test it out::
Fire up Chrome and head to https://localhost:8443[https://localhost:8443]. After clicking through the security warning
